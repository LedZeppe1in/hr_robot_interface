                ...
                ['label' => 'Редактор цифровой маски', 'url' => '#',
                    'items' => [
                        ['label' => 'Редактор цифровой маски (Иван)',
                            'url' => 'http://84.201.129.65:8080/HRRMaskEditor/MaskDrawIvan.html'],
                        ['label' => 'Редактор цифровой маски (Андрей)',
                            'url' => 'http://84.201.129.65:8080/HRRMaskEditor/MaskDrawAndr.html'],
                        ['label' => 'Сравнение алгоритмов Иван и Андрей',
                            'url' => 'http://84.201.129.65:8080/HRRMaskEditor/MaskDrawIvanAndAndrey.html'],
                        ['label' => 'Редактор цифровой маски отфильтрованное (Андрей)',
                            'url' => 'http://84.201.129.65:8080/HRRMaskEditor/MaskDrawAndr3.html'],
                        ['label' => 'Оценка цифровой маски',
                            'url' => 'http://84.201.129.65:8080/HRRMaskEditor/MaskWithResult.html'],
                    ],
                ],
                ['label' => 'Редактор тестов', 'url' => '#',
                    'items' => [
                        ['label' => 'Редактор простых вопросов',
                            'url' => 'http://84.201.129.65:8080/HRRTester/PollQuestionEditor.html'],
                        ['label' => 'Редактор составных вопросов',
                            'url' => 'http://84.201.129.65:8080/HRRTester/PollQuestionBunchEditor.html'],
                        ['label' => 'Список файлов с вопросами',
                            'url' => 'http://84.201.129.65:8080/HRRTester/Polls/'],
                        ['label' => 'Отображение опроса',
                            'url' => 'http://84.201.129.65:8080/HRRTester/GenerateR1Test.php?pollmodel=someTest.json'],
                    ],
                ],
                //['label' => 'Интерпретация признаков', 'url' => 'http://84.201.129.65:9999/Drools/Test.php'],
                //['label' => 'Редактор цифровой маски', 'url' => 'http://84.201.129.65:8080'],
