    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                '/video-interview/<_vi:(view|update|delete|video-download|get-ivan-landmarks|get-recognized-speech|get-andrey-landmarks|run-analysis|run-features-detection|run-features-interpretation)>/<id:\d+>' =>
