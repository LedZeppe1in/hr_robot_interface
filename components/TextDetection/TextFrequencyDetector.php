            ...
            if ($WordCount > 0)
                for ($i = 0; $i < $WordCount; $i++)
                    if (isset($theTextData[$i]) && isset($theTextData[$i][1]))
                        if ($theTextData[$i][1] > $theOtherVoiceEndsAtSec)
                            return $theTextData[$i][1];
        }
        return null;
    }
