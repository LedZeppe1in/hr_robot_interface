 ...
 */
class FacialFeatureDetectorExperiment
{
...
//                     else echo $k.'<br>';
    ...
    public function detectFeaturesV3($json,$basicFrame, $jsonA,$options,$textData)
    {
       ...
       file_put_contents('/var/www/hr-robot-interface.com/public_html/components/detectFeaturesV3_Exp_Andr.json', $jsonA);
       file_put_contents('/var/www/hr-robot-interface.com/public_html/components/detectFeaturesV3_Exp_Opt.json', json_encode($options));
...
//                $this->saveXY2($FaceData,'m1.json');
   ...
   // public function makeBasicFrameWithSmoothingAndRotating($theFaceData,$options)
    ...
    {
        file_put_contents('/var/www/hr-robot-interface.com/public_html/components/makeBasicFrame_ExpIvan.json', $theFaceData);
        file_put_contents('/var/www/hr-robot-interface.com/public_html/components/makeBasicFrame_Exp_Andr.json', $theFaceDataA);
        file_put_contents('/var/www/hr-robot-interface.com/public_html/components/makeBasicFrame_Opt_Exp.json', json_encode($options));
        file_put_contents('/var/www/hr-robot-interface.com/public_html/components/makeBasicFrame_Txt_Exp.json', json_encode($text));
